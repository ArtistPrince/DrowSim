...
video_path = "data/P1/Familiarization/DriverState/Face_cropped.mp4"  # Path to the face video
eye_tracking_file = "data/P1/Familiarization/DriverState/EyeTracking.txt"  # Path to the eye-tracking data
output_frames_dir = "extracted_frames_P1"
